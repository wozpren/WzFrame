...
public abstract class UserStoreBaseSuagr<TUser, TKey, TUserClaim, TUserLogin, TUserToken> :
    ...
    where TUserToken : IdentityUserToken<TKey>, new()
{
    ...
    public UserStoreBaseSuagr(IdentityErrorDescriber? describer)
    {
        if (describer == null)
        {
    ...
    /// </summary>
    public abstract ISugarQueryable<TUser> Users
    {
        get;
    }
...
public abstract class UserStoreBaseSuagr<TUser, TRole, TKey, TUserClaim, TUserRole, TUserLogin, TUserToken, TRoleClaim> :
    ...
    where TRoleClaim : IdentityRoleClaim<TKey>, new()
{
    ...
    /// </summary>
    /// <param name="describer">The <see cref="IdentityErrorDescriber"/> used to describe store errors.</param>
    public UserStoreBaseSuagr(IdentityErrorDescriber? describer) : base(describer) { }
